...
router.post('/register', async (req, res) => {
  try {
    ...
    const user = new User({
      ...
      height,
      weight,
      fitnessGoals: fitnessGoal ? [fitnessGoal] : [],
...
router.put('/me', auth, async (req, res) => {
  try {
    ...
    if (preferredWorkoutTypes !== undefined) user.preferredWorkoutTypes = preferredWorkoutTypes;
    if (weeklyWorkoutGoal !== undefined) user.weeklyWorkoutGoal = weeklyWorkoutGoal;
